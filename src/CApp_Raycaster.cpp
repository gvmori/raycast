...
double CApp::FindDistance(
    ...
    Vector2<int>* horiz_wall = FindWall(horiz_vertex, horiz_interval);
    Vector2<int>* vert_wall = FindWall(vert_vertex, vert_interval);
...
Vector2<int>* CApp::FindWall(Vector2<double>& vertex, Vector2<double>& interval) {
Vector2<int>* a = new Vector2<int>;
return a;
}
